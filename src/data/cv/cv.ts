  ...
  experiences: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Analyse des vulnérabilités critiques et accompagnement des équipes dans les plans de remédiation.",
        "Renforcement des mécanismes de détection et de réponse face aux incidents de sécurité.",
        "Participation à la mise en conformité sécurité et aux bonnes pratiques de gouvernance IT.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Mise en place de contrôles de sécurité CI/CD : analyse SAST, gestion des dépendances et revue de code.",
        "Supervision et analyse des événements de sécurité applicative afin de détecter les comportements anormaux.",
        "Participation aux audits techniques et recommandations de remédiation pour renforcer la résilience des systèmes.",
      ],
    },
  ],
  featuredProjects: [
