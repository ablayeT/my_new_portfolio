...
import { LEGAL_DOC } from "@/data/policies/legal";

export const runtime = "nodejs";

export const metadata: Metadata = {
  title: "Mentions légales — Abdoulaye Touré",
  description:
    "Éditeur, hébergeur, propriété intellectuelle, responsabilité, droit applicable.",
    ...
    <>
      ...
      <main className="container mx-auto grid gap-8 px-4 py-8 md:grid-cols-[1fr_280px]">
        <div className="min-w-0 space-y-6">
          <SectionCards doc={LEGAL_DOC} />
          <div className="mt-2 text-xs text-muted-foreground">
            Dernière mise à jour : {LEGAL_DOC.updatedAt}
          </div>
